...
/*
 * Structure for connections state
 *++
 */
...
//+++
#define ACTION_ISSET_CXT_DONT_CHECK_CLIENT(pi)  (pi->action_state->check & CXT_DONT_CHECK_CLIENT)
#define ACTION_ISSET_CXT_DONT_CHECK_SERVER(pi)  (pi->action_state->check & CXT_DONT_CHECK_SERVER)
#define ACTION_ISSET_DONT_CHECK_SERVICE(pi)     (pi->action_state->check & CXT_SERVICE_DONT_CHECK)
#define ACTION_ISSET_DONT_CHECK_CLIENT(pi)      (pi->action_state->check & CXT_CLIENT_DONT_CHECK)
#define ACTION_ISSET_SERVICE_UNKNOWN(pi)        (pi->action_state->check & CXT_SERVICE_UNKNOWN_SET)
#define ACTION_ISSET_CLIENT_UNKNOWN(pi)         (pi->action_state->check & CXT_CLIENT_UNKNOWN_SET)
//+++
...
//+++
    connState       *conn_state;     /*pointer to connection state */
...
//++OpenNF don't use these two parameters
