...
void add_asset(packetinfo *pi)
{
	...
	struct _asset *tmpasset = (struct _asset *)malloc(sizeof(struct _asset));

	if (assetGet(hash, tmpasset) == 1){
		masset->next = tmpasset;
	}else{
