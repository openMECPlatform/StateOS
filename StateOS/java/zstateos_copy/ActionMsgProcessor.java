...
import interfaces.msgprocessors.Allflows.ActionProcessShareStateAllflows;
...
public class ActionMsgProcessor extends ActionProcessShareStateAllflows {
    ...
    public void receiveShareStatePerflow(MyActionMessageProto.ShareState shareState) {
        ...
        ShareStateChunk actionStateChunk = new ShareStateChunk(actionStateStorage.getRunNFs().get("nf2"), shareState);
    ...
    public void receiveActionStateMultiflow(MyActionMessageProto.ActionMultiState actionMultiState) {
        ...
        ShareStateChunk actionStateChunk = new ShareStateChunk(actionStateStorage.getRunNFs().get("nf2"), actionMultiState);
        threadPool.submit(actionStateChunk);
    }
    ...
    public void receiveActionStateAllflow(MyActionMessageProto.ActionAllState actionAllState) {
        ...
        ShareStateChunk actionStateChunk = new ShareStateChunk(actionStateStorage.getRunNFs().get("nf2"), actionAllState);
        threadPool.submit(actionStateChunk);
    }
    ...
    public void addActionStateStorage(ActionStateStorage actionStateStorage){
        logger.info("send connection storage");
    ...
    public void initialAll(){
        ...
        multiflowAck = false;
        allflowAck = false;
        CopyProcessControl.isFirstRecv = false;
    }
