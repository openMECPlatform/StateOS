...
public class ShareStateAccelerateSFC {
    protected static Logger logger = LoggerFactory.getLogger(ShareStateAccelerateSFC.class);
    ...
    public static void main(String[] args) {
        ...
        ProcessCondition copyProcessControl = new AccelerateSFCControl(operationManager);
